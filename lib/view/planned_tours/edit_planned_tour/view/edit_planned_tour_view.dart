...
import '../../add_planned_tour/model/tour_accompanies_dd_model.dart';
import '../../add_planned_tour/model/tour_team_members_model.dart';
...
class _EditPlannedTourViewState extends State<EditPlannedTourView> {
  ...
  void getSelectedTourAccompanies(List<Map<String, dynamic>> items) {
    // items.map((element) => element.containsValue());
  }
    ...
    return BaseView<EditPlannedTourViewModel>(
      ...
      onPageBuilder:
          (BuildContext context, EditPlannedTourViewModel viewModel) =>
              Scaffold(
        appBar: AppBar(
          title: Text("Planlı Tur Düzenleme Sayfası"),
        ),
        body: Form(
          key: _formKey,
          child: ListView(
